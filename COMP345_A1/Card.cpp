...
static const std::string referenceCardDescription =
	...
	"Flip its cure marker from it's \"vial\" side to its \"(//)\" side.\n"
...
Card& Card::description(const std::string& description)
{
	_description = description;
	return *this;
}
...
{
	return std::make_unique<Card>("Reference Card", referenceCardDescription);
}
